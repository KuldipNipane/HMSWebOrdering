                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a href="service.html" class="nav-link dropdown-toggle">Service <i class='bx bx-chevron-down'></i></a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
            ...
            <div class="container">
                <div class="banner-content">
                    ...
                    <div class="banner-btn-wrap">
                        ...
                        <a class="banner-btn-two" href="contact-us.html">Get Free Call</a>
                    </div>
                </div>
                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-lg-6">
                        <div class="about-content">
                            ...
                            <a class="cmn-btn" href="service-details.html">Know More</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="blog-item">
                            ...
                            <div class="blog-bottom">
                                <h3>
                                    <a href="blog-details.html">Brief About How to Make Pasta</a>
                                </h3>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-6">
                        <div class="join-content">
                            ...
                            <a class="cmn-btn" href="contact-us.html">Apply Now</a>
                        </div>
                    </div>
                </div>
            </div>
